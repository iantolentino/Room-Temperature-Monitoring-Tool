...
import matplotlib.dates as mdates  # ADDED: Import missing module
...
# REMOVED: Duplicate function definition - keep only one copy of this function
# The function is already defined later in the StorageTemperatureReader class
